<template>
  <div class="h-screen w-full justify-center items-center flex py-14">
    <!-- MOVIE CONTAINER  -->
    <div
      class="bg-white h-full max-h-[50rem] w-[40rem] rounded-l-xl rounded-tr-xl"
    >
      <Nav
        class="rounded-t-xl"
        ...
        <div class="flex-1">
          <div class="flex flex-row w-full ml-2 gap-3">
            <input
              ...
              id="first_name"
              class="bg-gray-50 border border-gray-300 disabled:cursor-not-allowed disabled:bg-gray-200 text-gray-900 text-xs rounded-md block w-full p-2 ml-4 focus:outline-none"
            ...
            >
              <svg
                ...
                :class="{
                  'animate-spin direction-reverse': syncMoviesFlag,
                }"
                width="18"
                height="18"
                viewBox="0 0 24 24"
