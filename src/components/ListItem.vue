<template>
    <article class="p-4 sm:p-6 lg:p-4 xl:p-6 space-x-4 items-start sm:space-x-6 lg:space-x-4 xl:space-x-6 flex">
        <img :src="'https://image.tmdb.org/t/p/w400' + movie.poster_path" loading="lazy" decoding="async" alt=""
            width="60" height="88" class="flex-none rounded-md bg-slate-100 shadow-lg shadow-zinc-400" />
        <div class="min-w-0 relative flex-auto" @click="seeRowClicked">
            ...
            <dl class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                ...
                <div class="dark:text-slate-200">
                    ...
                    <dd class="px-1.5 ring-1 ring-slate-200 rounded dark:ring-slate-600">
...
const getGenres = async () => {
    ...
    state.movieGenres = data.genres.filter((item1: any) =>
        props.movie.genre_ids.some((item2: any) => item1.id == item2)
    );
};
